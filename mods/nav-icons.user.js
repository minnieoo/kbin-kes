function navbarIcons (toggle) {
    ...
    if (toggle) {
        document.styleSheets[0].addRule('header menu li a[aria-label="Search"] i::before', `content: '${search}'; font-family: 'sans-serif'; font-weight: ${weight * 100};`);
        document.styleSheets[0].addRule('header menu li a[aria-label="Add"] i::before', `content: '${post}'; font-family: 'sans-serif'; font-weight: ${weight * 100};`);
        document.styleSheets[0].addRule('header menu li a[aria-label="Select a channel"] i::before', `content: '${subs}'; font-family: 'sans-serif'; font-weight: ${weight * 100};`);
    } else {
